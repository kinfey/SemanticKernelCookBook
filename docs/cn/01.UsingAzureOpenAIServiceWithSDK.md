...
在上面我们已经配置好基于 .NET / Python 的 SDK 环境，接下来我们需要创建好链接的类以完成相关的初识化工作
...
我们用最原始，也是最基础的 SDK 与 Azure OpenAI Service 打交道，这也是我们面向生成式人工智能编程的第一步，在没有变成框架下可以更快速地理解不同接口，也为我们进入 Semantic Kernel 打下基础。
